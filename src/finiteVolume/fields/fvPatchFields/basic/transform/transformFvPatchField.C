...
template<class Type>
tmp<gpuField<Type> > transformFvPatchField<Type>::valueInternalCoeffs
(
...
template<class Type>
tmp<gpuField<Type> > transformFvPatchField<Type>::valueBoundaryCoeffs
(
    const tmp<scalargpuField>&
) const
{
...
template<class Type>
tmp<gpuField<Type> > transformFvPatchField<Type>::gradientInternalCoeffs() const
{
...
template<class Type>
tmp<gpuField<Type> > transformFvPatchField<Type>::gradientBoundaryCoeffs() const
{
    return
        snGrad()
