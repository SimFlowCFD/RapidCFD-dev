...
struct omegaWallFunctionFvPatchScalarFieldCreateWeightsFunctor: 
...
*/
    ...
    (
        ...
        thrust::make_permutation_iterator
        (omega.getField().begin(),patch().faceCells().begin()
        ),
        omegaWallFunctionFvPatchScalarFieldupdateCoeffsFunctor()
    );
    ...
    (
        ...
        thrust::make_permutation_iterator
        (omega.getField().begin(),patch().faceCells().end()
        ),
        omegaf.begin()
    );
