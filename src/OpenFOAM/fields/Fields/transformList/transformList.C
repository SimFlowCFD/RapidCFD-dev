...
template<class T>
void Foam::transformList(const tensorgpuField& f, UList<T>& l)
{
	Field<tensor> tf(f.asField());
    transformList(tf,l);
}

template<class T>
void Foam::transformList(const tensor& t, gpuList<T>& l)
{
   thrust::transform(l.begin(),l.end(),l.begin(),
                     transformBinaryFunctionSFFunctor<tensor,T,T>(t));
}

template<class T>
void Foam::transformList(const tensorgpuField& tf, gpuList<T>& l)
{
    thrust::transform(tf.begin(),tf.end(),l.begin(),l.begin(),
                     transformBinaryFunctionFunctor<tensor,T,T>());
}
