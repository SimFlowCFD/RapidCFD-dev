...
const Foam::pointgpuField& Foam::polyMesh::getPoints() const
{
    if (clearedPrimitives_)
    {
        FatalErrorIn("const pointField& polyMesh::points() const")
...
const Foam::faceDatagpuList& Foam::polyMesh::getFaces() const
{
    if (clearedPrimitives_)
    {
        FatalErrorIn("const faceList& polyMesh::faces() const")
...
const Foam::labelgpuList& Foam::polyMesh::getFaceNodes() const
{
    if (clearedPrimitives_)
    {
        FatalErrorIn("const faceList& polyMesh::faces() const")
...
const Foam::labelgpuList& Foam::polyMesh::getFaceOwner() const
{
    return gpuOwner_;
}
...
const Foam::labelgpuList& Foam::polyMesh::getFaceNeighbour() const
{
    return gpuNeighbour_;
}
...
const Foam::pointgpuField& Foam::polyMesh::getOldPoints() const
{
    if (gpuOldPointsPtr_.empty())
    {
        if (debug)
        {
            WarningIn("const pointgpuField& polyMesh::getOldPoints() const")
                << "Old points not available.  Forcing storage of old points"
                << endl;
        }
    ...
    return gpuOldPointsPtr_();
}

Foam::tmp<Foam::scalargpuField> Foam::polyMesh::movePoints
(
