...
const Foam::labelgpuList& Foam::fvPatchMapper::directAddressing() const
{
    if (!direct())
    {
        FatalErrorIn
...
const Foam::labelgpuListList& Foam::fvPatchMapper::addressing() const
{
    if (direct())
    {
        FatalErrorIn
...
const Foam::scalargpuListList& Foam::fvPatchMapper::weights() const
{
    if (direct())
    {
        FatalErrorIn
