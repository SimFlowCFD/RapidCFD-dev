...
#include "coordinateRotationFunctor.H"
...
Foam::tmp<Foam::vectorgpuField> Foam::EulerCoordinateRotation::transform
(
...
) const
{
    notImplemented
    (
        "tmp<vectorgpuField> Foam::EulerCoordinateRotation:: "
        "transform(const vectorgpuField& st) const"
    );
    return tmp<vectorgpuField>(NULL);
}
...
Foam::tmp<Foam::vectorgpuField> Foam::EulerCoordinateRotation::invTransform
(
    const vectorgpuField& st
) const
{
    ...
    (
        "tmp<vectorgpuField>  Foam::EulerCoordinateRotation::"
        "invTransform(const vectorgpuField& st) const"
    );
    return tmp<vectorgpuField>(NULL);
}
...
Foam::tmp<Foam::tensorgpuField> Foam::EulerCoordinateRotation::transformTensor
(
...
{
    tmp<symmTensorgpuField> tfld(new symmTensorgpuField(st.size()));
    symmTensorgpuField& fld = tfld();
