...
)
{
    ...
    pow<Type, r, GeoMesh>(tPow().getField(), df.getField());
...
)
{
    ...
    magSqr(tMagSqr().getField(), df.getField());
...
cmptAv(const DimensionedField<Type, GeoMesh>& df)
{
    ...
    cmptAv(CmptAv().getField(), df.getField());
    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            df1.dimensions() op dvs.dimensions()                              \
                                                                              ...
                                                                              \
    Foam::opFunc(tRes().getField(), df1.getField(), dvs.value());                   \
                                                                              \
    return tRes;                                                              \
}                                                                             \
                                                                              \
    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            dvs.dimensions() op df1.dimensions()                              \
                                                                              ...
                                                                              \
    Foam::opFunc(tRes().getField(), dvs.value(), df1.getField());                   \
                                                                              \
    return tRes;                                                              \
}                                                                             \
                                                                              \
