...
struct nutURoughCalcNutFunctor
{
    ...
    nutURoughCalcNutFunctor(const scalar yPlusLam_):yPlusLam(yPlusLam_){}
...
) const
{
    ...
    if (roughnessHeight_ > 0.0)
    {
        ...
        (
            y.begin(),
            y.end(),
            thrust::make_zip_iterator(thrust::make_tuple(nuw.begin(),magUp.begin())),
            yPlus.begin(),
            nutURoughCalcYPlusRoughFunctor
            (
                yPlusLam_,
...
/*		                 
    ...
    else
    {
        ...
        (
            ...
            thrust::make_zip_iterator(thrust::make_tuple(nuw.begin(),magUp.begin())),
            yPlus.begin(),
            nutURoughCalcYPlusSmoothFunctor(yPlusLam_,kappa_,E_)
        );
