...
void Foam::primitiveMesh::clearGeom()
{
    ...
    deleteDemandDrivenData(gpuCellCentresPtr_);
    deleteDemandDrivenData(gpuFaceCentresPtr_);
    deleteDemandDrivenData(gpuCellVolumesPtr_);
    deleteDemandDrivenData(gpuFaceAreasPtr_);
...
void Foam::primitiveMesh::clearAddressing()
{
    ...
    deleteDemandDrivenData(gpuCellDataPtr_);
    deleteDemandDrivenData(gpuCellFacesPtr_);
