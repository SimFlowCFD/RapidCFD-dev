...
template<class Type>
tmp<gpuField<Type> > zeroGradientFvPatchField<Type>::valueInternalCoeffs
(
...
template<class Type>
tmp<gpuField<Type> > zeroGradientFvPatchField<Type>::valueBoundaryCoeffs
(
    const tmp<scalargpuField>&
) const
{
...
template<class Type>
tmp<gpuField<Type> > zeroGradientFvPatchField<Type>::gradientInternalCoeffs() const
{
    return tmp<gpuField<Type> >
    (
        new gpuField<Type>(this->size(), pTraits<Type>::zero)
...
template<class Type>
tmp<gpuField<Type> > zeroGradientFvPatchField<Type>::gradientBoundaryCoeffs() const
{
    return tmp<gpuField<Type> >
    (
        new gpuField<Type>(this->size(), pTraits<Type>::zero)
