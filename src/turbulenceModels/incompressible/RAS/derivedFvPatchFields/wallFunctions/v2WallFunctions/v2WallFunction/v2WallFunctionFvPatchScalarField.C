...
struct v2WallFunctionFunctor
{
    const scalar Cmu25_;
    const scalar kappa_;
    const scalar yPlusLam_;

    v2WallFunctionFunctor(scalar Cmu25, scalar kappa, scalar yPlusLam):
                          Cmu25_(Cmu25), kappa_(kappa), yPlusLam_(yPlusLam){}
...
void v2WallFunctionFvPatchScalarField::updateCoeffs()
{
    ...
    (
        ...
        v2.begin(),
        v2WallFunctionFunctor(Cmu25,kappa_,yPlusLam_)
    );
