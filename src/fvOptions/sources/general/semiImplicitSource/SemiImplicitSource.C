...
)
{
    ...
    gpuIndirectList<Type>(Su.getField(), cells_) = injectionRate_[fieldI].first()/VDash_;
    ...
    gpuIndirectList<scalar>(Sp.getField(), cells_) = injectionRate_[fieldI].second()/VDash_;
