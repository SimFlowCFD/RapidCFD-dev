...
)
{
    ...
    fvm.diag() = rDtCoef*mesh().V().getField();
...
)
{
    ...
    scalar rDtCoef = rDtCoef_(ddt0).value();
    fvm.diag() = rDtCoef*rho.value()*mesh().V().getField();
...
)
{
    ...
    scalar rDtCoef = rDtCoef_(ddt0).value();
    fvm.diag() = rDtCoef*rho.internalField()*mesh().V().getField();
...
)
{
    ...
    scalar rDtCoef = rDtCoef_(ddt0).value();
    fvm.diag() = rDtCoef*alpha.internalField()*rho.internalField()*mesh().V().getField();
