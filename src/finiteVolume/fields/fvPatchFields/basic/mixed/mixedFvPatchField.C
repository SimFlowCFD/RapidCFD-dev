...
template<class Type>
tmp<gpuField<Type> > mixedFvPatchField<Type>::snGrad() const
{
    return
        valueFraction_
...
template<class Type>
tmp<gpuField<Type> > mixedFvPatchField<Type>::valueInternalCoeffs
(
...
template<class Type>
tmp<gpuField<Type> > mixedFvPatchField<Type>::valueBoundaryCoeffs
(
    const tmp<scalargpuField>&
) const
{
...
template<class Type>
tmp<gpuField<Type> > mixedFvPatchField<Type>::gradientInternalCoeffs() const
{
...
template<class Type>
tmp<gpuField<Type> > mixedFvPatchField<Type>::gradientBoundaryCoeffs() const
{
    return
