...
template<class Type>
tmp<gpuField<Type> > fixedValueFvPatchField<Type>::valueInternalCoeffs
(
...
template<class Type>
tmp<gpuField<Type> > fixedValueFvPatchField<Type>::valueBoundaryCoeffs
(
    const tmp<scalargpuField>&
) const
{
...
template<class Type>
tmp<gpuField<Type> > fixedValueFvPatchField<Type>::gradientInternalCoeffs() const
{
...
template<class Type>
tmp<gpuField<Type> > fixedValueFvPatchField<Type>::gradientBoundaryCoeffs() const
{
