...
Foam::tmp<Foam::vectorgpuField> Foam::STARCDCoordinateRotation::transform
(
...
Foam::tmp<Foam::vectorgpuField> Foam::STARCDCoordinateRotation::invTransform
(
    const vectorgpuField& st
) const
{
...
Foam::tmp<Foam::tensorgpuField> Foam::STARCDCoordinateRotation::transformTensor
(
...
Foam::tmp<Foam::symmTensorgpuField> Foam::STARCDCoordinateRotation::
transformVector
(
    const vectorgpuField& st
) const
