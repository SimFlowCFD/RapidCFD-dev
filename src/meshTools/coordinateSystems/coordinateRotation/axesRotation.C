...
Foam::tmp<Foam::vectorgpuField> Foam::axesRotation::transform
(
...
Foam::tmp<Foam::vectorgpuField> Foam::axesRotation::invTransform
(
    const vectorgpuField& st
) const
{
...
Foam::tmp<Foam::tensorgpuField> Foam::axesRotation::transformTensor
(
...
Foam::tmp<Foam::symmTensorgpuField> Foam::axesRotation::transformVector
(
    const vectorgpuField& st
) const
{
