...
#include "gpuCompactIOList.H"
#include "labelList.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class T, class BaseType>
void Foam::gpuCompactIOList<T, BaseType>::readFromStream()
{
...
template<class T, class BaseType>
Foam::gpuCompactIOList<T, BaseType>::gpuCompactIOList(const IOobject& io)
:
    regIOobject(io)
{
    if
...
template<class T, class BaseType>
Foam::gpuCompactIOList<T, BaseType>::gpuCompactIOList
(
    const IOobject& io,
    const label size
)
...
template<class T, class BaseType>
bool Foam::gpuCompactIOList<T, BaseType>::writeObject
(
...
template<class T, class BaseType>
bool Foam::gpuCompactIOList<T, BaseType>::writeData(Ostream& os) const
{
    return (os << *this).good();
}
...
template<class T, class BaseType>
void Foam::gpuCompactIOList<T, BaseType>::operator=
(
    const gpuCompactIOList<T, BaseType>& rhs
)
{
    gpuList<T>::operator=(rhs);
}
...
(
    Foam::Istream& is,
    Foam::gpuCompactIOList<T, BaseType>& L
)
{
    // Read compact
...
(
    Foam::Ostream& os,
    const Foam::gpuCompactIOList<T, BaseType>& L
)
{
