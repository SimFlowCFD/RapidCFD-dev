...
) const
{
    ...
    else
    {
        ...
        )
        {
            ...
            tensorField forT(Cf.size());
            tensorField revT(Cf.size());

            forAll(forT, facei)
            {
                forT[facei] = rotationTensor(-nr[facei], nf[facei]);
                revT[facei] = rotationTensor(nf[facei], -nr[facei]);
            }
            ...
            if (sum(mag(forT - forT[0])) < error)
            {
                ...
                gForwardT_.setSize(1);
                gForwardT_.set(0,forT[0]);
                gReverseT_.setSize(1);
                gReverseT_.set(0,revT[0]);
        ...
        else
        {
            ...
            gForwardT_.setSize(0);
            gReverseT_.setSize(0);
