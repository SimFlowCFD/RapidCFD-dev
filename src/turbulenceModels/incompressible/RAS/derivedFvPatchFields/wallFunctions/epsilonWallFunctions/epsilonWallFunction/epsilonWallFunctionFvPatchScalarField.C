...
*/
    ...
    weights.correctBoundaryConditions();
...
/*
    ...
    */
    ...
    (
        ...
        (
            thrust::make_permutation_iterator(epsilon.getField().begin(),  patch().faceCells().begin()),
            thrust::make_permutation_iterator(epsilon0.begin(),  patch().faceCells().begin())
        )),
        thrust::make_permutation_iterator(epsilon.getField().begin(),patch().faceCells().begin()),
        epsilonWallFunctionFvPatchScalarFieldupdateCoeffsFunctor()
    );
    ...
    (
        thrust::make_permutation_iterator(epsilon.getField().begin(),patch().faceCells().begin()),
        thrust::make_permutation_iterator(epsilon.getField().begin(),patch().faceCells().end()),
        epsilonf.begin()
    );
...
)
{
    ...
    thrust::copy_if
    (
        thrust::make_permutation_iterator(epsilon.getField().begin(),faceCells.begin()),
        thrust::make_permutation_iterator(epsilon.getField().begin(),faceCells.end()),
        weights.begin(),
