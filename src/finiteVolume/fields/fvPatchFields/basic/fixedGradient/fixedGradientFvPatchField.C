...
template<class Type>
tmp<gpuField<Type> > fixedGradientFvPatchField<Type>::valueInternalCoeffs
(
    const tmp<scalargpuField>&
) const
{
    return tmp<gpuField<Type> >(new gpuField<Type>(this->size(), pTraits<Type>::one));
}


template<class Type>
tmp<gpuField<Type> > fixedGradientFvPatchField<Type>::valueBoundaryCoeffs
(
    const tmp<scalargpuField>&
) const
{
...
template<class Type>
tmp<gpuField<Type> > fixedGradientFvPatchField<Type>::
