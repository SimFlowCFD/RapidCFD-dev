...
void Foam::primitiveMesh::calcFaceCentresAndAreas() const
{
    ...
    if (faceCentresPtr_ || faceAreasPtr_ ||
        gpuFaceCentresPtr_ || gpuFaceAreasPtr_)
    {
    ...
    gpuFaceCentresPtr_ = new vectorgpuField(fCtrs);
    gpuFaceAreasPtr_ = new vectorgpuField(fAreas);
...
const Foam::vectorgpuField& Foam::primitiveMesh::getFaceCentres() const
{
...
const Foam::vectorgpuField& Foam::primitiveMesh::getFaceAreas() const
{
    if ( ! gpuFaceAreasPtr_)
    {
        calcFaceCentresAndAreas();
