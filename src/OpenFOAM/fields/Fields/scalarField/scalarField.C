...
template class gpuField<scalar>;
...
void component(scalargpuField& sf, const gpuList<scalar>& f, const direction)
{
    sf = f;
}

template<>
void scalargpuField::replace(const direction, const gpuList<scalar>& sf)
{
    *this = sf;
}

template<>
void scalargpuField::replace(const direction, const scalar& s)
{
    *this = s;
}
...
{
    tmp<scalargpuField> tRes(new scalargpuField(sf.size()));
    stabilise(tRes(), sf, s);
    return tRes;
}
...
{                                                                                \
    ...
    return tRes;                                                                 \
                                                                                 ...
                                                                                 \
tmp<scalargpuField> func(const int n, const tmp<scalargpuField>& tsf)            \
{                                                                                \
    tmp<scalargpuField> tRes = reuseTmp<scalar, scalar>::New(tsf);               \
    func(tRes(), n, tsf());                                                      \
    reuseTmp<scalar, scalar>::clear(tsf);                                        \
    return tRes;                                                                 \
}
